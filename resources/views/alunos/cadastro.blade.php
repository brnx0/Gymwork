...
@section('content')
    <form action="/cadastro/alunos" method="post" id="formCreateAluno" class="container-full">@csrf  
        <div class="g-2 align-items-center">
            ...
            <div class="col-5">
                <input type="text" id="dadosPrincipais" class="form-control" name="nome" required>
            </div>
            <div class="col-auto">CPF:</div>
            <div class="col-2">
                <input type="text" id="dadosPrincipais" class="form-control" name="cpf" required>
            </div>
        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="Plano"  required>
